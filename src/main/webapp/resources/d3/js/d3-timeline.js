...
(function () {
  d3.timeline = function() {
    ...
    var qtipTitle = function (){},
        qtipContent = function (){},
        hover = function () {},
        mouseover = function () {},
        mouseout = function () {},
        click = function () {},
      ...
      g.each(function(d, i) {
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
            ...
            .attr("r", itemHeight / 2)
            .attr("height", itemHeight)
            .style({'stroke': 'black', 'stroke-width': '1',"fill" : function(d, i){
            ...
            .attr("qtip-title", function(d, i) { 
            	return qtipTitle(d, i, datum);
            })
            .attr("title", function(d, i) { // qtip uses title attribute by default for content
            	return qtipContent(d, i, datum);
            });
            ;
    ...
    timeline.qtipTitle = function (titleFunc) {
        if (!arguments.length) return qtipTitle;
        qtipTitle = titleFunc;
        return timeline;
      };
      
    timeline.qtipContent = function (titleFunc) {
        if (!arguments.length) return qtipContent;
        qtipContent = titleFunc;
        return timeline;
      };
